...
\title{Gravity from Quantum Measurement: From Microstates to Emergent Geometry}
...
The energy transfer $\Delta E$ implied by equation~\eqref{eq:UL} is carried by a physical quantum — matter or radiation — mediating the measurement interaction. We refer to this as the \emph{thrust quantum} of effective mass $m_t$. (This will actually be a pure energy carrier our later microstate example.)
